...
{
    public interface IScheduleServiceContext
    {
        DbSet<User> Users { get; set; }
        DbSet<Role> Roles { get; set; }
        DbSet<Tenant> Tenants { get; set; }
        DbSet<DigitalAsset> DigitalAssets { get; set; }
        DbSet<ScheduledItem> ScheduledItems { get; set; }
        DbSet<Brand> Brands { get; set; }
        Task<int> SaveChangesAsync();
    }

    public class ScheduleServiceContext: DbContext, IScheduleServiceContext
    {
        public ScheduleServiceContext()
            :base("ScheduleServiceContext")
        {
